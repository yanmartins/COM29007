...
for SNR = 0 : SNR_max
    ...
    info_hat = info_rx_filter(N : N : end) > limiar1; % Informação estimada
...
legend('Sinalização NRZ unipolar SEM filtro casado','Sinalização NRZ unipolar COM filtro casado');
hold off;
